...
import { listMenu, deleteMenu } from "../query/menu";
...
const Details = () => {
  const [menulist, setmenulist] = useState(arrmenuProps);
  ...
  const [deletedata, setdeletedata] = useState<deleteProps>({
    ...
    type: "alert",
    successButtonText: "Delete menu",
    successAction: () => {},
    cancelAction: () => {},
  });
  const [editdata, seteditdata] = useState<menuProps>({
    _id: "",
    parent: "",
    name: "",
    link: "",
  ...
  return (
    <>
      ...
      {showaddedit ? (
        <AddEdit
          closePopUp={closeAddEdit}
          data={{ data: editdata, list: menulist }}
        />
      ) : (
        ""
      )}
