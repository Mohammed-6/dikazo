...
import { listPageCategory, deletePageCategory } from "../query/category";
...
const Details = () => {
  const [categorylist, setcategorylist] = useState(arrPageCategoryProps);
  ...
  useEffect(() => {
    listPageCategory().then((response) => {
  ...
  const successAction = () => {
    deletePageCategory(deleteid).then((response) => {
      setcategorylist(response.data.data);
      setdeleteaction(false);
    });
  };
      ...
      <div className="card">
        ...
        <div className="flex flex-col">
          <div className="overflow-x-auto">
            <div className="py-3 pl-2 hidden">
                    ...
                    {categorylist !== undefined &&
                      categorylist.map((dd, k) => (
                        <tr>
                          ...
                          <td className="px-6 py-4 text-sm text-gray-800 whitespace-nowrap">
                            <Link
                              href={"/admin/category/edit/" + dd._id}
